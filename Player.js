...
export default class Player extends React.Component {
     ...
     *                          del video player
     */
    CreateVideoPlayer(videoPath, UpdateState, updateIsPlayingVideo, nextState, idAnswer, UpdateUserAnswer) {
        ...
        const videoPlaying = this.props.IsPlayingVideo;
            ...
            if (!isClickedAux && !videoPlaying) {
                return (
                    ...
                    <VrButton
                        onClick={() => this.CreateVideoPlayer(videoPath, this.props.UpdateState, this.props.UpdateIsPlayingVideo, this.props.nextState, this.props.answerID, this.props.updateAnswerUser)}
                        onExit={this._blur}
                        onEnter={this._focus} 
                    >
                        <Animated.View
